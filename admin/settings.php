...
function manage_child_sponsorship_callback(){
	do_action('child_sponsorship_gs_cb_action');
}




function child_sponsorship_gs_settings_free(){
	?>
		<div class="wrap">
...
add_action('child_sponsorship_gs_cb_action', 'child_sponsorship_gs_settings_free');
